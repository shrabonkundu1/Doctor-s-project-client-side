        ...
        <div className="flex  md:flex-row w-full rounded-lg md:h-[500px] justify-center items-center gap-24 md:gap-16 flex-col-reverse  mt-24 md:mt-36 mb-24">
          <div className="relative ">
            <img
              ...
              src="https://i.ibb.co.com/B5p9Lc3B/youre-as-fit-as-a-fiddle-shot-of-a-dentist-and-a-patient-using-a-tablet-in-a-office-1536x1025.jpg"
              alt=""
            />
            <img
              ...
              src="https://i.ibb.co.com/F4t4XgFT/Our-Service2.jpg"
              alt=""
            />
          ...
          <div className="flex-1  h-full w-full md:pl-24 space-y-5">
            ...
            <Link to={'/services'}>
            <button className="bg-gradient-to-r from-blue-600 mt-5 to-blue-200 px-10 py-3 rounded-full text-white cursor-pointer">
              Learn More
            </button>
            </Link>
          </div>
